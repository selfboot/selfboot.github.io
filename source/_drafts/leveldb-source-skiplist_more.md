...
那么跳表的平均性能如何呢？前面给出过结论，和平衡树的平均性能差不多。引入一个简单的随机高度，就能保证跳表的平均性能和平衡树差不多。**这背后有没有什么分析方法，能够分析跳表的性能呢**？还得看论文，论文中给出了一个不错的分析方法，这里可以一起看看。

这里的性能分析思路其实有点难想到，每一步也涉及到一些数学推导，我会把问题尽量拆分，然后一步步来推导整个过程。哈哈，**这不就是思维链嘛，拆解问题并逐步推理，是人和 AI 解决复杂问题的必备技能啊**。这里的推导可以分为几个小问题：
...
先放弃直接分析，来尝试回答前面第二个问题。**假设从第 K 层开始往下找，平均要多少次才能找到目标位置**呢？
